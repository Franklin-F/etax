...
class CreateGetInvoice(BaseCommand):
    help = 'Create GetInvoice Task'
...
class BatchGetInvoice(BaseCommand):
    help = 'Batch getinvoice'
    ...
    def handle(self, *args, **options):
        ...
        for account in accounts:
            GetInvoice.objects.create(begin_date=begin_date, end_date=end_date, mode=mode, **account)
